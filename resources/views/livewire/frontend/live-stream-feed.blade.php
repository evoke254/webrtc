    ...
    <div class="w-full mx-auto block">
        ...
        <div class="flex flex-col lg:flex-row rounded-lg gap-4 my-4 p-6 bg-gradient-to-r from-primary-50 to-primary-100 dark:from-zinc-800 dark:to-zinc-900 shadow-sm border border-primary-200 dark:border-zinc-700 relative mx-auto">
            <div class="lg:max-w-xl w-full">
                ...
                <p class="text-base text-gray-600 dark:text-zinc-100">
                ...
                <div class="mt-4 flex gap-3">
                    ...
                    <button class="px-4 py-2 bg-white hover:bg-gray-50 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-primary-600 dark:text-primary-400 border border-primary-200 dark:border-zinc-600 rounded-full text-sm font-medium transition-all">
                        Browse Creators
                    </button>
                </div>
            </div>
                                ...
                                <div class="flex items-start gap-3" >
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center gap-1 mt-1">
                                            <span class="text-sm text-gray-600 dark:text-zinc-300">{{ $stream->user ? $stream->user->fullname : 'Unknown User' }}</span>
